...
namespace EnumerableTask {
    ...
    public class Task {
        ...
        public IEnumerable<string> GetPrefixItems(IEnumerable<string> data, string prefix) {
			...
			return data.Where(x => x[0]== prefix[0]);
        }
        ...
        public IEnumerable<int> Get3TopItems(IEnumerable<int> data) {
			...
			return data.OrderBy(x => x).Reverse().Take(3);
        }
        ...
        public int GetCountOfStringsWithLengthEqualsTo3(IEnumerable<string> data) {
			...
			//return data.Where(x => String.IsNullOrEmpty(x) ? false : x.Length == 3).Count();
			throw new NotImplementedException();
        }
        ...
        public int GetCountOfStringsWithMaxLength(IEnumerable<string> data) {
			...
			return data.Where(x => String.IsNullOrEmpty(x) ? 0 == data.Max().Length : x.Length == data.Max().Length).Count();
        }
        ...
        public IEnumerable<string> SortDigitNamesByNumericOrder(IEnumerable<string> data) {
            ...
            return data.OrderBy(x=> Array.IndexOf(new string [] {"zero", "one","two","three","four","five","six","seven","eight","nine","ten"},x));
        }
        ...
        public IEnumerable<string> CombineNumbersAndFruits(IEnumerable<string> numbers, IEnumerable<string> fruits) {
			...
			return numbers.Where((x, index) => index <= fruits.Count() - 1).Select((x, index) => String.Format("{0} {1}",x,fruits.ElementAt(index)));
        }
        ...
        public bool IsAllStringsAreUppercase(IEnumerable<string> data) {
			...
			return data.DefaultIfEmpty().All(x => String.IsNullOrEmpty(x) ? false : x.ToUpper()==x);
        }
