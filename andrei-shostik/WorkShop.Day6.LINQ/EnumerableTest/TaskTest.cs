...
namespace EnumerableTest
{
    ...
    public class TaskTest
    {
        ...
        {
            GetPrefixItemsTest(new[] { "olo" }, null, new string[] { }, null);
        }

        #endregion GetPrefixItems tests
        ...
        #endregion PropagateItemsByPostionIndex tests
        ...
        public void GetUsedChars_Should_Return_List_of_Chars()
        {
            GetUsedCharsTest(
                ...
                new[] { 'a', 'b', 'c', 'd', ' ' },
                "GetUsedChars should return list of used chars 1"
            );
            GetUsedCharsTest(
                new[] { "aa", "aaa", "aaaaaa", "aaaa" },
                new[] { 'a' },
                "GetUsedChars should return list of used chars 2"
            );
            GetUsedCharsTest(
                new[] { " ", "  ", "   ", "   " },
                new[] { ' ' },
                "GetUsedChars should return list of used chars 3"
            );
            GetUsedCharsTest(
        ...
        public void GetDigitCharsCount_Should_Return_Number_Of_Digit_Chars()
        {
            GetDigitCharsCountTest("aaaa", 0,
                "GetDigitCharsCount should return 0 if data has no digits 1"
                );
        ...
        public void GetQuarterSales_Should_Return_Right_Results()
        {
            ...
            GetQuarterSalesTest(
                ...
                new[] { 10, 10, 0, 10 },
                "GetQuarterSales should return right results2"
                );
            GetQuarterSalesTest(
        ...
        public void SortStringsByLengthAndAlphabet_Should_Return_Right_Results()
        {
            ...
            SortStringsByLengthAndAlphabetTest(
                new[] { "c", "cc", "b", "bb", "a", "aa" },
                new[] { "a", "b", "c", "aa", "bb", "cc" },
                "GetQuarterSales should return right result1"
                );
            SortStringsByLengthAndAlphabetTest(
                new[] { "aaaaa", "aaaa", "aaa", "aa", "a" },
                new[] { "a", "aa", "aaa", "aaaa", "aaaaa" },
                "GetQuarterSales should return right result2"
                );
        }
        ...
        public void CombineNumbersAndFruits_Should_Return_Right_Results()
        {
            ...
            CombineNumbersAndFruitsTest(
                ...
                "CombineNumbersAndFruits should return right result1"
                );
            CombineNumbersAndFruitsTest(
                new[] { "one", "two" },
                new[] { "apple", "bananas", "pineapples" },
                new[] { "one apple", "two bananas" },
                "CombineNumbersAndFruits should return right result2"
                );
            CombineNumbersAndFruitsTest(
                new[] { "one", "two", "three" },
                new[] { "apple" },
                new[] { "one apple" },
                "CombineNumbersAndFruits should return right result3"
                );
            CombineNumbersAndFruitsTest(
                Enumerable.Repeat("one", 100),
                Enumerable.Repeat("apple", 100),
                Enumerable.Repeat("one apple", 100),
                "CombineNumbersAndFruits should return right result4"
            );
        }
        ...
        public void GetCommonChars_Should_Return_Right_Results()
        {
            ...
            GetCommonCharsTest(
                new[] { "ab", "ac", "ad" },
                "a",
                "GetCommonChars should return right results1"
                );
            GetCommonCharsTest(
                new[] { "a", "b", "c" },
                string.Empty,
                "GetCommonChars should return right result2"
                );
            GetCommonCharsTest(
                new[] { "a", "aa", "aaa", "aaaa" },
                "a",
                "GetCommonChars should return right result3"
                );
            GetCommonCharsTest(
                new[] { "ab", "ba", "aabb", "baba" },
                "ab",
                "GetCommonChars should return right result4"
                );
            GetCommonCharsTest(
               new[] { string.Empty, "a", "aa", "aaa" },
               string.Empty,
               "GetCommonChars should return right result5"
            );
        }
        ...
        public void GetFirstNegativeSubsequence_Should_Return_Right_Results()
        {
            GetFirstNegativeSubsequenceTest(
                new int[] { -2, -1, 0, 1, 2 },
                new int[] { -2, -1 },
                "GetFirstNegativeSubsequence should return right results1"
                );
            GetFirstNegativeSubsequenceTest(
                new int[] { 2, 1, 0, -1, -2 },
                new int[] { -1, -2 },
            ...
            GetFirstNegativeSubsequenceTest(
                ...
                new int[] { -1, -1, -1 },
                "GetFirstNegativeSubsequence should return right results3"
                );
            GetFirstNegativeSubsequenceTest(
                new int[] { -1, 0, -2 },
                new int[] { -1 },
                "GetFirstNegativeSubsequence should return right results4"
                );
            GetFirstNegativeSubsequenceTest(
                new int[] { 1, 2, 3 },
                new int[] { },
                "GetFirstNegativeSubsequence should return right results5"
                );
            GetFirstNegativeSubsequenceTest(
                new int[] { },
                new int[] { },
        ...
        public void AreNumericListsEqual_Should_Return_Right_Results()
        {
            AreNumericListsEqualTest(
                ...
                true,
                "AreNumericListsEqual should return right results1"
                );
            AreNumericListsEqualTest(
                new int[] { 1, 2, 3 },
                new double[] { 3.0, 2.0, 1.0 },
                false,
                "AreNumericListsEqual should return right results2"
                );
            AreNumericListsEqualTest(
                Enumerable.Range(1, 100),
                Enumerable.Range(1, 100).Select(x => (double)x),
                true,
                "AreNumericListsEqual should return right results3"
                );
            AreNumericListsEqualTest(
                new int[] { -10 },
                new double[] { -10.0 },
                true,
                "AreNumericListsEqual should return right results4"
                );
        }
