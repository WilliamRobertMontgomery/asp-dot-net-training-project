...
namespace EnumerableTask {
    ...
    public class Task {
        ...
        public IEnumerable<string> GetPrefixItems(IEnumerable<string> data, string prefix) {
            ...
            return data.DefaultIfEmpty(String.Empty).Where(x => (x != null) && ((x.Contains(prefix)) || x.Contains(prefix.ToLower()) || x.Contains(prefix.ToUpper())));
        ...
        public IEnumerable<T> GetEvenItems<T>(IEnumerable<T> data) {
           ...
           // return data.Select((x,index) =>(data.Take(index) % 2!=0) ? x:null);
        ...
        public IEnumerable<T> PropagateItemsByPositionIndex<T>(IEnumerable<T> data) {
            ...
            return data.SelectMany((x, ind) =>   Enumerable.Repeat(x,ind+1));
        ...
        public IEnumerable<char> GetUsedChars(IEnumerable<string> data) {
            ...
            return data.DefaultIfEmpty(string.Empty).Aggregate<IEnumerable<char>>((result,current)=>  result.Union(current!=null ? current : string.Empty));
        ...
        public int GetCountOfGreaterThen10(IEnumerable<int> data) {
            ...
            return data.OrderByDescending(x => x).Where(x => x > 10).Count();
            throw new NotImplementedException();
        }
        ...
        public string GetFirstContainsFirst(IEnumerable<string> data) {
            ...
            return data.DefaultIfEmpty(String.Empty).Where(x => x.ToUpper().Contains("FIRST")).FirstOrDefault(null);
            throw new NotImplementedException();
        }
        ...
        public int GetCountOfStringsWithLengthEqualsTo3(IEnumerable<string> data) {
            ...
            return data.Where(x => (x==null?String.Empty:x).Length==3 ).Distinct().Count();
        ...
        public int GetCountOfStringsWithMaxLength(IEnumerable<string> data) {
            ...
            return data.Where(x => (x ?? string.Empty).Length == data.Max(t => (t ?? string.Empty).Length)).Count();
            throw new NotImplementedException();
        }
        ...
        public int GetDigitCharsCount(string data) {
            ...
            return data.Where(y=>Char.IsDigit(y)).Count();
